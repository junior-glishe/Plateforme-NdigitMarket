<?php
/**
 * NDIGITMARKET - Admin trait : Categories
 * CRUD complet des catégories (respecte la colonne `image_cat` de la BDD).
 */
...
trait CategoriesTrait
{
    ...
    /**
     * Petit helper d'upload sécurisé (extensions image usuelles).
     */
