            ...
            <div class="bg-[#0F172A] rounded-2xl p-4 text-white">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-gray-400"><?= ucfirst($role ?? 'Invité') ?></p>
                    </div>
                </div>
                <a href="<?= BASE_URL ?>/index.php?logout=1"
                    class="text-xs text-gray-300 hover:text-white transition flex items-center gap-2"> <i class="fas fa-sign-out-alt"></i> Déconnexion
                </a>
            </div>
        </div>
    </div>
...
<script>window.NDIGIT_BASE_URL = <?= json_encode($__base) ?>;</script>
