...
<body>
<?php $currentPage = 'gestion-commande'; require_once __DIR__ . '/../components/sidebar.php'; ?>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden" data-paginate data-page-size="25">
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <?php if (empty($orders)): ?>
                        <tr><td colspan="10" class="px-4 py-6 text-center text-sm text-gray-400">Aucune commande trouvée.</td></tr>
...
<script>
    ...
    (function() {
        document.body.addEventListener('click', function(e) {
            ...
            if (!modal) return;
            let payload;
            try { payload = JSON.parse(trigger.getAttribute('data-order')); } catch (_) { return; }
