...
new Swiper('.testimonial-swiper', {
    ...
    slidesPerView: 1,
    spaceBetween: 20,
    autoHeight: false,           ← important: false pour hauteur uniforme
    pagination: {
...
<section class="hero">
    <div class="hero-content">
        <div class="hero-badge">
            <span></span>
            +5 000 ressources disponibles maintenant
        </div>
    ...
    <div class="container">
        ...
        <div class="swiper swiper-main" id="featuredSwiper">
            <div class="swiper-wrapper">
                <?php
                // Récupérer les produits les plus vendus (top ventes)
                // CORRECTION: Utilisation de p.id au lieu de p.id_article
                $resultats = $database->query('
                    SELECT p.*, c.nom_categorie, COUNT(co.id_article) as nombre_commandes
                    FROM produits p
                ...
                // Si pas de produits avec commandes, afficher les derniers ajouts
                if (empty($featuredProducts) || $featuredProducts[0]['nombre_commandes'] == 0) {
                    $resultats = $database->query('
                        SELECT p.*, c.nom_categorie, 0 as nombre_commandes
                        FROM produits p
                        INNER JOIN categories c ON p.categorie_id = c.id
                ...
                <div class="swiper-slide">
                    <div class="product-grid grid-4">
                        <?php foreach ($slide as $i => $produit):
                            ...
                            // Déterminer le badge de classement
                            $rank = $i + 1;
                            $badgeClass = '';
                            $badgeText = '';
                            if ($produit['nombre_commandes'] > 0) {
                                if ($rank == 1) {
                                    ...
                                    $badgeText = '🥇 #1 des ventes';
                                } elseif ($rank == 2) {
                                    $badgeClass = 'badge-silver';
                                    $badgeText = '🥈 #2 des ventes';
                                } elseif ($rank == 3) {
                                    $badgeClass = 'badge-bronze';
                                    $badgeText = '🥉 #3 des ventes';
                                } else {
                        ...
                        <div class="featured-card">
                            <div class="featured-img">
                                ...
                                <?php endif; ?>
                                <?php if ($hasSale): ?>
                                <div class="discount-tag">-<?php echo $disc; ?>%</div>
                                <?php endif; ?>
                            ...
                            <div class="featured-body">
                                ...
                                <a href="product_detail.php?nom_article=<?php echo urlencode($produit['nom_article']); ?>" class="featured-name">
...
<section class="section">
    <div class="container">
        ...
        $firstTab = true;
        foreach ($tabCats as $tc):
            // Récupérer les produits les plus vendus par catégorie
            // CORRECTION: Utilisation de p.id au lieu de p.id_article
            ...
            // Si aucun produit avec commandes dans cette catégorie, prendre les plus récents
            if (empty($tabProds)) {
                $tabRes = $database->prepare('
                    SELECT p.*, c.nom_categorie, 0 as nombre_commandes
                    FROM produits p
        ...
        <div class="tab-content <?php echo $firstTab ? 'active' : ''; ?>" id="tab-<?php echo strtolower($tc); ?>">
            <div class="product-grid grid-5">
                <?php foreach ($tabProds as $index => $produit):
                    ...
                    // Badges basés sur le nombre de ventes
                    $rank = $index + 1;
                    if ($produit['nombre_commandes'] > 0) {
                        if ($rank == 1) {
                            $badgeText = '🔥 #1';
                        ...
                        <div class="product-footer">
                            ...
                            <div style="display: flex; align-items: center; gap: 8px;">
                                ...
                                <span class="sales-count">
                                    <i class="fa-solid fa-fire"></i> <?php echo $produit['nombre_commandes']; ?>
                                </span>
                                <?php endif; ?>
...
<section class="section">
    <div class="container">
        ...
        <!-- Grille avec 5 colonnes sur desktop, 2 sur mobile -->
...
<!-- =========================================================
     SECTION : POURQUOI CHOISIR NDIGITMARKET
========================================================== -->
<section class="section why-choose-section">
    <div class="container">
        <div class="section-header" style="justify-content:center; text-align:center; display:block; margin-bottom: 40px;">
            <div class="section-label" style="justify-content:center;">✨ Pourquoi NDIGITMARKET</div>
            <h2 class="section-title">La référence des templates web en Afrique</h2>
            <p class="section-subtitle">Des milliers de développeurs et designers nous font confiance</p>
        </div>
        ...
        <div class="why-choose-grid">
            <div class="why-choose-card">
                ...
                <h3>Fichiers 100% vérifiés</h3>
                <p>Chaque template est testé manuellement par notre équipe avant mise en ligne pour garantir qualité et fonctionnalité.</p>
            </div>
            ...
            <div class="why-choose-card">
                ...
                <p>Téléchargement immédiat après paiement. Plus d'attente, vous recevez vos fichiers en quelques secondes.</p>
            </div>
            ...
            <div class="why-choose-card">
                ...
                <h3>Support premium inclus</h3>
                <p>Une équipe de développeurs à votre écoute 7j/7 pour vous aider avec vos achats et installations.</p>
            </div>
            ...
            <div class="why-choose-card">
                ...
                <p>Transactions cryptées et protection des données. Paiement par carte, Mobile Money ou Orange Money.</p>
            </div>
            ...
            <div class="why-choose-card">
                ...
                <p>Bénéficiez des mises à jour de vos templates pendant 6 mois après l'achat, sans frais supplémentaires.</p>
            </div>
            ...
            <div class="why-choose-card">
                ...
                <h3>Licence commerciale</h3>
                <p>Tous nos templates incluent une licence commerciale pour utilisation dans vos projets clients.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="section section-bg">
    <div class="container">
        <div class="section-header" style="justify-content:center; text-align:center; display:block; margin-bottom: 40px;">
            ...
            <h2 class="section-title">Votre confiance, notre priorité</h2>
        </div>
        <div class="trust-grid">
            <div class="trust-card">
                <div class="trust-icon">✅</div>
                <div class="trust-title">Fichiers vérifiés</div>
                <div class="trust-desc">Chaque template est testé et validé avant d'être mis en ligne.</div>
            </div>
            <div class="trust-card">
                <div class="trust-icon">⚡</div>
                <div class="trust-title">Livraison instantanée</div>
                <div class="trust-desc">Téléchargement immédiat dès la confirmation de votre paiement.</div>
            </div>
            <div class="trust-card">
                <div class="trust-icon">🛡️</div>
                <div class="trust-title">Paiement sécurisé</div>
                <div class="trust-desc">Transactions protégées et données personnelles sécurisées.</div>
            </div>
            <div class="trust-card">
                <div class="trust-icon">💬</div>
                <div class="trust-title">Support 24/7</div>
                <div class="trust-desc">Notre équipe vous assiste rapidement pour toute question.</div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="trust-stats">
            <div class="trust-stat-item">
                <div class="trust-stat-number">5 000+</div>
                <div class="trust-stat-label">Clients satisfaits</div>
            </div>
            <div class="trust-stat-item">
                <div class="trust-stat-number">15 000+</div>
                <div class="trust-stat-label">Templates vendus</div>
            </div>
            <div class="trust-stat-item">
            ...
            <div class="trust-stat-item">
                ...
                <div class="trust-stat-label">Support disponible</div>
            </div>
        </div>
    </div>
</section>
