...
<body class="bg-gradient-custom min-h-screen">
        ...
        if (empty($email) || empty($mdp)) {
            ...
            try {
                ...
                if ($admin) {
                    ...
                    if ($passwordValid) {
                        $adminRole = \App\Core\Permission::normalizeRole((string) ($admin['role'] ?? ''));

                        // Vérifier que le rôle est valide (existe dans le système RBAC)
                        $validRoles = ['Super Admin', 'Admin', 'Modérateur', 'Support'];
    ...
    <div class="flex min-h-screen">
                ...
                <div class="text-center mb-8">
                    <div class="flex justify-center mb-4">
                        <div class="w-14 h-14 bg-primary/10 rounded-2xl flex items-center justify-center overflow-hidden">
                            <img
                                src="/back-end/public/assets/images/favi.png"
                                alt="icon"
        ...
        <div class="hidden lg:flex lg:w-1/2 relative items-center justify-center bg-gray-900">
            <img
                src="/back-end/public/assets/IMAGE/LOGO.svg"
